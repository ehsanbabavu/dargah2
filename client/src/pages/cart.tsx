...
import { ShoppingCart, Plus, Minus, Trash2, Package, MapPin, CreditCard } from "lucide-react";
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button 
                    ...
                    disabled={proceedToCheckoutMutation.isPending || payFromBalanceMutation.isPending || !selectedAddressId}
